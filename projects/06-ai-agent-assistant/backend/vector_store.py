"""
Ek single local Chroma collection — yeh project vector stores compare
nahi karta (woh Project 5 tha), isko bas `search_handbook` tool ke liye
search karne ke liye KAHIN par jagah chahiye. Vector database kya karta
hai aur yahan cosine distance kyun use hota hai, iski fuller explanation
ke liye Project 4/5 ka vector_store.py dekho.
"""
